...
/**
 * הטבלה — שורות ליגה, לא גרף.
 *
 * ★ שונה מכוונה מ-`IconRanking`: שם עמודות (מי מוביל בתחרות),
 *   כאן שורות (מה מצב הליגה). שני אייקונים דומים בסרגל אחד הם
 *   שני כפתורים שאף אחד לא יודע להבדיל ביניהם.
 */
export function IconTable() {
  return (
    <Svg>
      <rect x="3" y="4.5" width="18" height="15" rx="2.2" {...S} />
      <path d="M3 9.5h18M3 14.5h18M9 9.5V19.5" {...S} opacity=".65" />
    </Svg>
  );
}
